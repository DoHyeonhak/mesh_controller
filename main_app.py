...
class App:
    ...
    def _create_widgets(self):
        ...
        self.get_node_tx_button.grid(row=2, column=0, columnspan=4, sticky="ew", padx=5, pady=2)
        ...
        self.test_all_ms_entry = ttk.Entry(test_all_frame, width=10)
        self.test_all_ms_entry.pack(side="left", padx=5)
        self.test_all_ms_entry.insert(0, "1000")
        ...
        set_power_frame.grid(row=4, column=0, columnspan=4, sticky='ew', pady=2)
        ...
        netoff_frame.grid(row=5, column=0, columnspan=4, sticky='ew', pady=2)
